...
def main():
    ...
    for city in cities:
        # Selection: First home of the city (last 72 hours)
        target_home = f"{city}_00"
        ...
        print(f"Generating plot for {target_home}...")
        ...
        y_pred = [max(0.03, p) for p in y_pred]
        ...
        plt.title(f'Load Forecasting: Actual vs Predicted ({city})', fontsize=14, fontweight='bold')
        ...
        plot_path = os.path.join(RESULTS_DIR, f"load_forecast_{city.lower()}.png")
